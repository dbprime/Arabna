...
const go = async (h) => { await page.evaluate(x => { location.hash = x; }, h); await shown(page, h, 340); };
...
ok('the account is at tier 2 for the add-business flow', await page.evaluate(async () => {
